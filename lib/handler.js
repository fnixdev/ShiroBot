        ...
        case "sticker":
            {
                ...
                if (imageMessage) {
                    ...
                    client.sendMessage(senderNumber, { sticker: bufferImage, mimetype: 'image/webp' }, { quoted: message });
                    console.log("Mensagem emviada, tentando deletar o arquivo");
                    await deleteFile(imagePath);
                } else {
                    client.sendMessage(senderNumber, { text: "Opa desculpa, cadê a foto mano?" })
                }
                break;
            }
        ...
        case "gifsticker":
            {
                ...
                if (message.message.videoMessage.seconds > 8) {
                    client.sendMessage(senderNumber, { text: "Hmm ... no máximo 8 segundos, aguarde..." }, {
                        quoted: message
                    });
                    break;
                }
                ...
                if (videoMessage) {
                    ...
                    client.sendMessage(senderNumber, { text: "Opa mano, cadê o vídeo ou gif?" })
                }
                break;
            }
